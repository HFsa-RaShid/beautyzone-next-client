...
const CheckoutPage = () => {
  ...
  const handleShippingChange = (cost) => setShippingCost(cost);
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <div className="w-full lg:w-[65%] bg-white p-8 md:p-12 shadow-sm rounded-sm">
                ...
                {["firstName", "lastName", "email", "phone"].map((field) => (
                  <div key={field} className="space-y-1">
                    ...
                    <input
                      ...
                      required
                      defaultValue={
                        user ? (field === "email" ? user.email : "") : ""
                      } // ইউজার থাকলে ইমেইল অটো-ফিল
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-5">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <select
                      name="state"
                      className="w-full border border-gray-200 p-3 text-sm bg-white appearance-none"
                    >
                      <option>Dhaka</option>
                    </select>
                    <ChevronDown
            ...
            <section>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <label
                    key={method.label}
                    className="flex items-center justify-between border border-gray-200 p-4 cursor-pointer hover:bg-gray-50"
                  >
            ...
            <button
              type="submit"
              className="mt-10 bg-black text-white w-full py-4 uppercase font-bold text-xs tracking-widest hover:bg-gray-800 transition flex justify-center items-center gap-2"
            >
          ...
          <div className="w-full lg:w-[35%]">
            <div className="bg-white p-8 shadow-sm">
              <h2 className="text-[12px] font-bold uppercase tracking-widest mb-8 text-gray-400">
                Order Summary
              </h2>
              <div className="space-y-6 mb-8 max-h-75 overflow-y-auto">
                {items.map(({ product, quantity }) => (
                  <div key={product._id} className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-[11px] font-bold uppercase leading-tight">
                        {product.name}
                      </h3>
