                ...
                {[
                  ...
                  <label key={method.label} className="flex items-center justify-between border border-gray-200 p-4 cursor-pointer hover:bg-gray-50">
                    <div className="flex items-center gap-3">
                      <input type="radio" name="shipping" checked={shippingCost === method.cost} onChange={() => handleShippingChange(method.cost)} className="accent-black" />
          ...
          <div className="w-full lg:w-[35%]">
            <div className="bg-white p-8 shadow-sm">
              ...
              <div className="border-t pt-6 space-y-4">
                <div className="flex justify-between text-xs font-bold uppercase"><span>Subtotal</span><span>${subtotal.toFixed(2)}</span></div>
                <div className="flex justify-between text-xs font-bold uppercase"><span>Shipping</span><span>${shippingCost.toFixed(2)}</span></div>
                <div className="flex justify-between text-xl font-bold pt-4 border-t"><span>Total</span><span>${total.toFixed(2)}</span></div>
              </div>
            </div>
          </div>
        </form>
