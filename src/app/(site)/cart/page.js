                ...
                <div className="flex-1 flex justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-8">
                      <button onClick={() => updateQuantity(product._id, -1)} className="p-3 border border-gray-100">
                        <Minus size={12} />
                      </button>
                  ...
                  <div className="text-right">
                    ...
                    <button onClick={() => removeFromCart(product._id)} className="mt-4 text-red-600 hover:text-red-500 transition-colors">
                      <Trash2 size={18} />
                    </button>
                  </div>
                </div>
